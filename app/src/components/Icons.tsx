...
export const Mail = (props: Omit<IconProps, 'name'>) => (
  <Feather name="mail" {...props} />
);

export const Lock = (props: Omit<IconProps, 'name'>) => (
  <Feather name="lock" {...props} />
);

export const Eye = (props: Omit<IconProps, 'name'>) => (
  <Feather name="eye" {...props} />
);

export const EyeOff = (props: Omit<IconProps, 'name'>) => (
  <Feather name="eye-off" {...props} />
);
