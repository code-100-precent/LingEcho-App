      ...
      <AnimatePresence>
        {isOpen && inputValue && filteredOptions.length > 0 && (
          <motion.div
            ...
            className="absolute z-50 w-full top-full mt-1 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg max-h-60 overflow-auto"
          >
