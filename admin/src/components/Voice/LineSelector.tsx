  ...
  return (
    <div className="mb-3 flex items-center justify-center">
      <div className="relative bg-gray-100 dark:bg-neutral-700 rounded-xl p-1 flex gap-1 shadow-inner">
        ...
        <button
          className={`relative z-10 px-4 py-1.5 text-sm rounded-lg transition-all duration-200 ${lineMode === 'websocket' ? 'text-blue-700 dark:text-blue-300 scale-[1.02]' : 'text-gray-700 dark:text-gray-200 hover:text-gray-900'} `}
          ...
          <div className="px-4 py-3 bg-gray-900 dark:bg-gray-100 text-white dark:text-gray-900 text-sm rounded-lg shadow-xl max-w-sm mx-4">
            ...
            <div className="space-y-2">
              <div className="flex items-start gap-2">
                <span>
                  <span className="text-blue-300 dark:text-blue-600 font-medium">线路1：</span>
                  此线路是WebRTC实时通信，超低延迟，适合连续对话，不过该通信方式使用了RustPBX，需要安装部署RustPBX, 示例网站可能不支持使用， 如有问题请联系我们。
                </span>
              </div>
              <div className="flex items-start gap-2">
                <span>
                  <span className="text-cyan-300 dark:text-cyan-600 font-medium">线路2：</span>
