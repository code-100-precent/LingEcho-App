  ...
  const renderBackground = () => {
    ...
    return (
      <div className={`fixed inset-0 bg-gradient-to-br ${currentTheme.background} z-0`}>
        ...
        {/* 光晕效果 */}
        <div className="absolute top-1/4 left-1/4 w-96 h-96 rounded-full bg-sky-500/20 blur-3xl animate-pulse" />
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 rounded-full bg-cyan-500/20 blur-3xl animate-pulse" style={{ animationDelay: '2s' }} />
      </div>
    )
  }
